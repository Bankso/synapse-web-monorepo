import{cL as k,cK as z,cJ as L,cv as D,cI as b,d7 as h,j as r,V as j,gr as v}from"./iframe-CqK7cJYB.js";import{c as l}from"./UserBadge-DszVeQ9P.js";import"./index-r8ZA1smB.js";import"./SkeletonTable-DR3-Ofey.js";import"./MenuItem-sLh309bQ.js";import"./Card-BPc34rtl.js";import"./Chip-Bs-SomAb.js";const G={title:"UI/UserCard",component:l,render:function(d){const{data:c}=h();let t=c==null?void 0:c.ownerId;return t===v.toString()&&(t=void 0),r.jsxs(r.Fragment,{children:[r.jsx("p",{children:"If you are logged in, your avatar or card will appear. If you are not logged in, enter an ownerId (e.g. 273960) or alias (e.g. brucehoff) below."}),r.jsx(l,{ownerId:d.ownerId??t,...d})]})}},e={args:{size:k,avatarSize:"SMALL"}},a={args:{size:z}},s={args:{size:L}},o={decorators:[i=>r.jsx(j,{sx:{maxWidth:"450px"},children:r.jsx(i,{})})],args:{size:L,menuActions:[{field:"Action 1",callback:()=>{console.log("Action 1 clicked")}},{field:D},{field:"Action 2",callback:()=>{console.log("Action 2 clicked")}},{field:"Action 3",callback:()=>{console.log("Action 3 clicked")}}]}},n={args:{size:b}};var m,A,p;e.parameters={...e.parameters,docs:{...(m=e.parameters)==null?void 0:m.docs,source:{originalSource:`{
  args: {
    size: AVATAR,
    avatarSize: 'SMALL'
  }
